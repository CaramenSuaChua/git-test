...
import { fetchSalary, fetchStaffs, fetchDeparts, postStaff } from '../redux/ActionCreator';
        ...
        return (
            <div>
                <Switch  >
                    ...
                    <Route path='/detail/:id' component={() => { return <Detail staffs={this.props.staffs.staffs} departs={this.props.departs} /> }} />
